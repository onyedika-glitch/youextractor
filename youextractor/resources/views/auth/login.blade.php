...
<head>
    ...
    <title>Sign In - YouExtractor</title>
    ...
    <div class="relative w-full max-w-md p-8 glass-panel">
        <div class="bg-gray-800/50 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-8 shadow-2xl">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-400">Sign in to access your extracted projects</p>
            </div>
            ...
            <p class="mt-8 text-center text-sm text-gray-500">
                By continuing, you verify that you are a real person and agree to our 
        ...
        <div class="text-center mt-6">
            <p class="text-gray-400 text-sm">
                ...
                <a href="/register" class="text-purple-400 font-semibold hover:text-purple-300">Sign up</a>
            </p>
        </div>
    </div>
