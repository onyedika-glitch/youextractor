            ...
            <div class="auth-container">
                ...
                <ds-card variant="glass-accent" padding="lg">
                    ...
                    <form method="POST" action="{{ route('signup.submit') }}" id="signupForm">
                        ...
                        <!-- Submit Button -->
                        <div style="position: relative; margin-top: var(--theme-spacing-2); width: 100%;">
                            <ds-button type="submit" label="Create Account" variant="primary" size="lg" full-width></ds-button>
                            @if(($lastUsedAuth ?? '') === 'email')
                                <span class="last-used-badge" style="top: -8px; right: 12px; left: auto; box-shadow: 0 2px 6px rgba(37, 99, 235, 0.25);">Last used</span>
                            @endif
                        </div>
                    </form>
